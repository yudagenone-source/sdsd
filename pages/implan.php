...
<head>
    ...
    <title>Implan Gigi - Seuri Dental Specialist</title>
...
<body>
        ...
        <div class="container dentalseuri2-container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5 position-relative text-center">
                    ...
                    <img src="<?= image('implanhero.png') ?>" alt="senyum" class="dentalseuri2-main-image">
                </div>
                ...
                <div class="col-md-6">
                    <h2 class="dentalseuri2-title">
                        Because Every Smile
                        Deserves Natural Look
                        and True Confidence
                    </h2>
                    <p class="dentalseuri2-desc">
                        Membantu Anda mengembalikan senyum dengan percaya diri, nyaman, dan hasil jangka panjang. Kami
                        menyediakan perawatan implan gigi profesional dalam lingkungan estetik yang terpercaya.</p>
                    <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20implan%20gigi%20di%20Seuri%20Dental.%20-seuri.id" class="btn dentalseuri2-btn">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 about-content" style="padding-left: 1rem;">
                    ...
                    <h3 style="font-weight: 400;">
                        Seuri Dental Clinic menyediakan berbagai layanan implant untuk mengembalikan gigi yang hilang
                        agar kembali kuat, indah, dan nyaman diantaranya;
                    </h3>
                    ...
                    <ul class="list-unstyled ms-3 mt-3">
                        <li class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="mb-0 fw-normal">Neobiotech (made in Korea)</h4>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-6 d-flex justify-content-center justify-content-lg-end mt-4 mt-lg-0">
                    <img src="<?= image('implanservices.webp') ?>" alt="Dokter gigi sedang melayani pasien"
    ...
    <section class="about-section py-5">
        <div class="container about-container">
            <div class="row align-items-center flex-column-reverse flex-lg-row">
                ...
                <!-- Kolom Gambar -->
                <div class="col-lg-6 d-flex justify-content-center justify-content-lg-start mt-4 mt-lg-0">
                    <img src="<?= image('whyimplan.webp') ?>" alt="Dokter gigi sedang melayani pasien"
    ...
    <h1 class="fw-bold mb-4" style="color: #5880a4; font-size: 50px;">
        Why Must Implant at Seuri?
    </h1>

    <div class="text-start">
        <div style="display: flex; align-items: flex-start; margin-bottom: 1rem;">
            <div style="flex-shrink: 0; margin-right: 15px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>">
            </div>
            <div style="flex: 1;">
                <h4 style="font-weight: 400; font-size: 25px; margin: 0;">
                    Menggunakan implant dari brand terkemuka (Osstem, dll)
                </h4>
            </div>
        </div>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 1rem;">
            ...
            <div style="flex: 1;">
                <h4 style="font-weight: 400; font-size: 25px; margin: 0;">
                    Proses implant dilakukan oleh dokter gigi spesialis berpengalaman
                </h4>
            </div>
        </div>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 1rem;">
            ...
            <div style="flex: 1;">
                <h4 style="font-weight: 400; font-size: 25px; margin: 0;">
                    Area operasi yang steril dan nyaman
                </h4>
            </div>
        </div>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 1rem;">
            ...
            <div style="flex: 1;">
                <h4 style="font-weight: 400; font-size: 25px; margin: 0;">
                    Menggunakan alat canggih dan teknologi modern
                </h4>
            </div>
        </div>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 1rem;">
            ...
            <div style="flex: 1;">
                <h4 style="font-weight: 400; font-size: 25px; margin: 0;">
                    Garansi perawatan hingga tiga bulan
                </h4>
            </div>
        </div>
    </div>
        ...
        <div class="container about-container">
            <div class="row align-items-center" style="--bs-gutter-x: 4rem;">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 d-flex justify-content-end" style="margin-bottom: 0 !important;">
                    <img src="<?= image('implancond.png') ?>" alt="Dokter gigi sedang melayani pasien"
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start" style="padding-left: 1rem;">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #6381a8; font-size: 40px;">Conditions Treated by

                            Our Implant Specialist </h1>

                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Kehilangan gigi karena patah</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Kehilangan gigi karena infeksi</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Kehilangan gigi karena dicabut</h3>
                            </li>
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed " type="button"
                            ...
                            Apakah perawatan implan gigi bisa menggunakan asuransi?
                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Perawatan implan gigi secara umum tidak termasuk dalam tanggungan asuransi kesehatan standar. Namun, beberapa asuransi menanggung biaya implan gigi.
                            <br><br>SeuriChingu bisa periksa kembali polis asuransi yang dimiliki atau konsultasikan langsung dengan pihak asuransi dan Seuri Dental Specialist untuk mendapatkan penjelasan lebih detail mengenai cakupan biaya dan opsi pembayaran yang tersedia.
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button"
                            ...
                            Berapa lama perawatan implan gigi di Seuri dental specialist?

                        </button>
                    </h2>
                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Durasi pemasangan implan gigi di Seuri Dental Specialist selama enam bulan yang dibagi menjadi beberapa tahapan. Tahapan pertama berlangsung kurang lebih 60-90 menit untuk memasukan alat implan ke dalam tulang. Tahapan kedua enam bulan setelah observasi berlangsung selama 45-60menit untuk cetak dan persiapan pemasangan crown. Tahapan ketiga berlangsung selama 30-60 menit untuk pemasangan gigi tiruan (crown) . Seuri Dental Specialist menyediakan layanan perawatan implan gigi dengan dokter gigi spesialis berpengalaman dan profesional untuk memastikan hasil yang maksimal dan minim nyeri.
                        </div>
                    </div>
                </div>
    ...
    <section style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container text-left">
            <h2 class="fw-bold text-secondary">
                Implan Gigi: Solusi Permanen untuk Gigi Hilang
            </h2>
            <p id="artikel" class="mt-4">
                Kehilangan gigi dapat memengaruhi penampilan, cara berbicara, hingga kenyamanan saat makan. Salah satu solusi terbaik untuk
                mengatasi hal ini adalah implan gigi. Berbeda dengan gigi palsu lepasan, implan gigi dirancang permanen dan menyatu dengan tulang
                rahang sehingga terasa lebih alami.
                <br><br>

                Implan gigi adalah sekrup titanium kecil yang ditanam ke dalam tulang rahang sebagai pengganti akar gigi. Di atasnya, dipasang mahkota
                gigi buatan yang menyerupai gigi asli, baik dari segi bentuk maupun warna. Hasilnya, implan terlihat natural dan berfungsi layaknya gigi
                normal.

                <br><br>
                Keunggulan implan gigi antara lain:
                <br>
                Lebih nyaman dibanding gigi palsu lepasan.
                <br>
                Menjaga struktur tulang rahang agar tidak menyusut.
                <br>
                Tahan lama bila dirawat dengan baik.
                <br>
                Membantu mengembalikan rasa percaya diri dengan senyum alami.

                <br><br>
                Prosedur pemasangan implan gigi dilakukan oleh dokter gigi spesialis dengan perencanaan yang matang. Setelah implan terpasang, pasien
                tetap perlu menjaga kebersihan mulut serta rutin kontrol untuk memastikan hasil optimal.

                <br><br>
                Jika Anda mencari solusi permanen untuk mengganti gigi yang hilang, implan gigi adalah pilihan modern dan efektif yang dapat
                meningkatkan fungsi sekaligus estetika senyum Anda.
            </p>
