...
<head>
    ...
    <title>Veener Gigi - Seuri Dental Specialist</title>
        ...
        <div class="container dentalseuri2-container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5 position-relative text-center">
                    ...
                    <img src="<?= image('veenerhero.png') ?>" alt="senyum" class="dentalseuri2-main-image">
                </div>

                <!-- Kolom Kanan -->
                <div class="col-md-6">
                    <h2 class="dentalseuri2-title">
                        Get A Flawless Smile with
                        Veneer
                    </h2>
                    <p class="dentalseuri2-desc">
                        Dokter gigi di Seuri merancang dan memasang veneer yang sesuai dengan kondisi gigi Anda untuk menampilkan senyum terbaik dan penuh percaya diri. </p>
                    <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20veneer%20gigi%20di%20Seuri%20Dental.%20-seuri.id" class="btn dentalseuri2-btn">
        ...
        <div class="container about-container">
            <div class="row align-items-center about-row">
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start align-self-start">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #5880a4; font-size: 50px;">Our Veneer Services</h1>
                        <h3 style="font-weight: 400;">
                            Seuri Dental Clinic menyediakan berbagai pilihan perawatan veneer:
                        </h3>
                        <br>
                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Veneer direct (Komposit)</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Veneer indirect (Porcelain)</h3>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container mt-5 d-flex justify-content-center">
        <div class="text-start">
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Ditangani oleh dokter gigi yang profesional dan berpengalaman
            </h4>
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Tampilan veener yang estetis dan natural
            </h4>
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Menggunakan alat modern dan teknologi canggih
            </h4>
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Menangani 100+ kasus veneer
            </h4>
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Menggunakan pendekatan smile design untuk hasil yang optimal
            </h4>
        </div>
    </div>
</section>
    ...
    <section class="before-after-section">
        <div class="container ba-container">
            ...
            <div class="text-left mb-5">
                <h2 class="ba-section-title">Before After Treatment Veneer Gigi</h2>
                <h4>Lihat Hasil Treatment Veneer Gigi di Seuri Dental Clinic!</h4>
            </div>
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start" style="padding-left: 1rem;">
                    <div>
                        ...
                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Gigi Berubah Warna (Stain/Kuning)</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Gigi Retak atau Patah Ringan</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Gigi Berbentuk Tidak Rata</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Celah di Antara Gigi (Diastema)</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Permukaan Gigi Terkikis (Erosi Enamel)</h3>
                            </li>
                        </ul><br>
                        <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20veneer%20gigi%20di%20Seuri%20Dental.%20-seuri.id" class="btn dentalseuri2-btn">
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq1">
                            Apakah perawatan veneer gigi bisa menggunakan asuransi?

                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Perawatan pencabutan veneer gigi secara umum tidak termasuk dalam tanggungan asuransi kesehatan standar karena dianggap perawatan estetik atau kosmetik. Namun, beberapa asuransi menanggung biaya implan gigi.
                            <br> <br>
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq2">
                            Berapa lama perawatan veneer gigi di Seuri dental specialist?
                    ...
                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Durasi perawatan veneer gigi di Seuri Dental Specialist berlangsung satu kali kunjungan atau lebih bergantung pada jenis veneer yang dipilih. Seuri Dental Specialist menyediakan layanan perawatan veneer gigi dengan dokter gigi spesialis berpengalaman dan profesional untuk memastikan hasil yang minim nyeri dan maksimal dengan alat canggih dan modern.
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button"
                            ...
                            Berapa biaya perawatan veneer gigi di Seuri Dental Specialist?
                    ...
                    <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Biaya perawatan veneer gigi dengan dokter gigi spesialis di Seuri Dental Specialist mulai dari harga Rp. 1.000.000 per gigi bergantung pada tingkat kesulitan kasus.
    ...
    <section style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container text-left">
            <h2 class="fw-bold text-secondary">
                Veneer Gigi Terdekat untuk Solusi Senyum Lebih Cerah
            </h2>
            <p id="artikel" class="mt-4">
                Memiliki senyum indah dengan gigi putih dan rapi kini lebih mudah diwujudkan melalui veneer gigi terdekat. Veneer adalah lapisan tipis
                berbahan porselen atau resin komposit yang ditempelkan pada permukaan gigi untuk memperbaiki bentuk, warna, maupun posisi gigi.

                <br><br>
                Mengapa memilih veneer gigi? Prosedur ini dapat mengatasi berbagai masalah estetika, seperti gigi kuning yang sulit diputihkan, gigi patah
                atau retak, celah antar gigi, hingga bentuk gigi yang tidak rata. Hasilnya tampak alami dan bisa bertahan lama bila dirawat dengan baik.
                <br><br>

                Keunggulan melakukan veneer gigi terdekat adalah akses yang lebih cepat dan mudah, tanpa harus bepergian jauh. Klinik gigi modern
                biasanya menawarkan berbagai pilihan veneer sesuai kebutuhan dan budget, mulai dari direct veneer (resin komposit) hingga porcelain
                veneer yang lebih awet dan estetik.

                <br><br>
                Sebelum melakukan veneer, konsultasi dengan dokter gigi sangat penting untuk menentukan jenis veneer yang tepat serta memastikan
                kondisi gigi sehat. Setelah pemasangan, pasien perlu menjaga kebersihan mulut, rutin kontrol, dan menghindari kebiasaan buruk seperti
                menggigit benda keras.

                <br><br>
                Segera temukan veneer gigi terdekat agar Anda bisa mendapatkan senyum putih, rapi, dan lebih percaya diri dalam setiap kesempatan.
            </p>
