...
<head>
    ...
    <title>Gigi Tiruan - Seuri Dental Specialist</title>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .dentalseuri2-ornament-brown,
            .dentalseuri2-ornament-grey {
                display: none; /* Sembunyikan ornamen di mobile */
            }
            ...
            /* Background kanan di mobile - lebih kecil dan lebih transparan */
            .why-trust-bg {
                width: 200px;
                opacity: 0.2;
...
<body>
        ...
        <div class="container dentalseuri2-container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5 position-relative text-center">
                    ...
                    <img src="<?= image('gigitiruanhero.png') ?>" alt="senyum" class="dentalseuri2-main-image">
                </div>

                <!-- Kolom Kanan -->
                <div class="col-md-6">
                    <h2 class="dentalseuri2-title">
                        Complete your Smile<br>
                        Complete your Life
                    </h2>
                    <p class="dentalseuri2-desc">
                        Mengembalikan penampilan senyum Anda, menopang otot wajah, serta membantu Anda mengunyah dan berbicara lebih baik dari sebelumnya. 
                    </p>
                    <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20gigi%20tiruan%20(di%20Seuri%20Dental).%20-seuri.id" class="btn dentalseuri2-btn">
        ...
        <div class="container about-container">
            <div class="row" style="--bs-gutter-x: 4rem;">
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start align-self-start" style="padding-left: 1rem;">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #5880a4; font-size: 50px;">Our Denture Services</h1>
                        <h3 style="font-weight: 400;">Seuri Dental Clinic menyediakan berbagai pilihan perawatan gigi tiruan:</h3>

                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Gigi tiruan lepasan</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Gigi tiruan cekat</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Bridge atau jembatan gigi</h3>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- SECTION WHY TRUST - YANG SUDAH DIPERBAIKI -->
        ...
        <div class="container why-trust-content">
            <div class="text-center">
                <h1 class="fw-bold" style="color: #5880a4; font-size: 50px;">
                    Why Patients Trust Our Prosthodontist
                </h1>
            </div>
            ...
            <div class="container mt-5 d-flex justify-content-center">
                <div class="text-start">
                    <h4 style="font-weight: 400; font-size: 25px;">
                        <img style="width:48px;" src="<?= image('blink.png') ?>"> Ditangani oleh dokter gigi spesialis prostodonsia yang berpengalaman
                    </h4>
                    <h4 style="font-weight: 400; font-size: 25px;">
                        <img style="width:48px;" src="<?= image('blink.png') ?>"> Desain yang nyaman dan estetis
                    </h4>
                    <h4 style="font-weight: 400; font-size: 25px;">
                        <img style="width:48px;" src="<?= image('blink.png') ?>"> Dibuat khusus mengikuti bentuk gusi dan gigi
                    </h4>
                    <h4 style="font-weight: 400; font-size: 25px;">
                        <img style="width:48px;" src="<?= image('blink.png') ?>"> Menjaga dari perubahan bentuk wajah
                    </h4>
                    <h4 style="font-weight: 400; font-size: 25px;">
                        <img style="width:48px;" src="<?= image('blink.png') ?>"> Garansi gigi tiruan hingga satu bulan
                    </h4>
                </div>
            </div>
        </div>
    ...
    <!-- Sisa kode sebelum-after, testimoni, dll tetap sama -->
    <section class="before-after-section">
        <div class="container ba-container">
            <div class="text-left mb-5">
                <h2 class="ba-section-title">Before After Gigi Tiruan</h2>
                <h4>Lihat Hasil Treatment Gigi Tiruan di Seuri Dental Clinic!</h4>
            </div>
    ...
    <section class="about-section">
        <div class="container about-container">
            <div class="row align-items-center" style="--bs-gutter-x: 4rem;">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 d-flex justify-content-end" style="margin-bottom: 0 !important;">
                    <img
                        src="<?= image('conditions-gigitiruan.png') ?>"
                        alt="Dokter gigi sedang melayani pasien"
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start" style="padding-left: 1rem;">
                    <div>
                        ...
                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Gigi hilang sebagian</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Gigi hilang seluruhnya</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Gigi goyang</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Setelah pencabutan gigi</h3>
                            </li>
                        </ul><br>
                        <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20gigi%20tiruan%20(di%20Seuri%20Dental).%20-seuri.id" class="btn dentalseuri2-btn">
    ...
    <section style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container text-left">
            <h2 class="fw-bold text-secondary">
                Gigi Tiruan: Solusi Praktis untuk Mengganti Gigi Hilang
            </h2>
            <p id="artikel" class="mt-4">
                Kehilangan gigi dapat mengganggu fungsi mengunyah, berbicara, hingga kepercayaan diri. Salah satu solusi yang banyak dipilih adalah
                menggunakan gigi tiruan. Gigi tiruan berfungsi menggantikan gigi yang hilang, baik sebagian maupun seluruhnya, sehingga penampilan dan
                fungsi mulut kembali normal.
                <br><br>

                Ada beberapa jenis gigi tiruan yang umum digunakan, antara lain:
                <br>
                Gigi tiruan lepasan, dapat dilepas-pasang sesuai kebutuhan.
                <br>
                Gigi tiruan sebagian, menggantikan beberapa gigi yang hilang.
                <br>
                Gigi tiruan penuh, digunakan jika semua gigi sudah hilang.
                <br>
                Gigi tiruan permanen seperti bridge atau implan, yang lebih stabil dan natural.

                <br><br>
                Pemilihan jenis gigi tiruan biasanya disesuaikan dengan kondisi mulut, kebutuhan fungsional, serta anggaran pasien. Konsultasi dengan
                dokter gigi sangat penting untuk menentukan pilihan terbaik.
                <br><br>

                Perawatan gigi tiruan pun perlu diperhatikan. Bersihkan secara rutin, hindari makanan terlalu keras, dan lakukan kontrol ke dokter gigi agar
                gigi tiruan tetap nyaman dipakai.

                <br><br>
                Dengan menggunakan gigi tiruan yang tepat, Anda bisa mengembalikan senyum alami, meningkatkan kepercayaan diri, sekaligus menjaga
