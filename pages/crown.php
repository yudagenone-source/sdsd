        ...
        <div class="container dentalseuri2-container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5 position-relative text-center">
                    ...
                    <img src="<?= image('crownhero.png') ?>" alt="senyum" class="dentalseuri2-main-image">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <p class="dentalseuri2-desc">
                        Mengembalikan gigi bentuk, warna, dan kekuatan gigi menjadi kembali seperti gigi asli untuk menjaga struktur wajah dan makan kembali nyaman.</p>
                    <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20crown%20gigi%20di%20Seuri%20Dental.%20-seuri.id" class="btn dentalseuri2-btn">
            ...
            <div class="row align-items-center about-row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <div class="about-image-wrapper shadow-lg">
                        <img src="<?= image('crown.webp') ?>" alt="Dokter gigi sedang melayani pasien"
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start align-self-start">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #5880a4; font-size: 50px;">Our crown services</h1>
                        <h3 style="font-weight: 400;">
                            Seuri dental clinic menyediakan berbagai jenis crown diantaranya;
                        </h3>
                        <br>
                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                ...
                                <h3 style="font-weight: 400;" class="mb-0">Metal crown
                                </h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Porcelain fused to metal crown</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Emax crown</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Zirconia crown </h3>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container mt-5 d-flex justify-content-center">
        <div class="text-start">
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Ditangani oleh dokter gigi spesialis profesional dan berpengalaman
            </h4>
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Menggunakan alat modern dan teknologi canggih
            </h4>
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Telah menangani 100+ kasus crown and bridge
            </h4>
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Garansi perawatan hingga satu bulan
            </h4>
        </div>
    </div>
</section>
    ...
    <section class="before-after-section">
        <div class="container ba-container">
            ...
            <div class="text-left mb-5">
                <h2 class="ba-section-title">Before After Dental Crown</h2>
        ...
        <div class="container about-container">
            <div class="row align-items-center" style="--bs-gutter-x: 4rem;">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 d-flex justify-content-end" style="margin-bottom: 0 !important;">
                    <img src="<?= image('crowncond.png') ?>" alt="Dokter gigi sedang melayani pasien"
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start" style="padding-left: 1rem;">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #6381a8; font-size: 40px;">Conditions Treated by Our
                            Prosthodontic or Conservative</h1>

                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Gigi yang patah sebagian</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Gigi berlubang besar</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Gigi pasca perawatan saluran akar</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Pendekatan estetik</h3>
                            </li>
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq1">
                            Apakah perawatan crown gigi bisa menggunakan asuransi?
                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Perawatan gigi tiruan secara umum tidak termasuk dalam tanggungan asuransi kesehatan standar. Namun, beberapa asuransi menanggung biaya crown gigi.
                            <br> <br>
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq2">
                            Berapa lama perawatan crown gigi di Seuri dental specialist?
                    ...
                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Durasi pemasangan crown gigi di Seuri Dental Specialist selama dua minggu hingga satu bulan yang dibagi menjadi beberapa tahapan bergantung dari pilihan jenis crown dan tingkat kesulitan kasus.
                            <br><br>Seuri Dental Specialist menyediakan layanan perawatan crown gigi dengan dokter gigi spesialis berpengalaman dan profesional untuk memastikan hasil yang maksimal dan minim nyeri.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item border-0 border-bottom">
                    ...
                    <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Biaya pemasangan gigi tiruan dengan dokter gigi umum maupun spesialis prosthodonsia di Seuri Dental Specialist mulai dari harga Rp. 4.000.000 bergantung pada pilihan bahan yang dipakai.
