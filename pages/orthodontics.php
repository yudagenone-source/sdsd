        ...
        <div class="container dentalseuri2-container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5 position-relative text-center">
                    ...
                    <img src="<?= image('smile.webp') ?>" alt="senyum" class="dentalseuri2-main-image">
                </div>

                <!-- Kolom Kanan -->
                <div class="col-md-6">
                    <h2 class="dentalseuri2-title">
                        Get a Straighter Smile<br>
                        with a Trusted<br>
                    ...
                    <p class="dentalseuri2-desc">
                        Rapikan gigi Anda dengan aman dengan perawatan terbaik dari orthodontist bersertifikat di Seuri Dental Clinic. </p>
                    <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20orthodontic%20(behel)%20di%20Seuri%20Dental.%20-seuri.id0" class="btn dentalseuri2-btn">
        ...
        <div class="container about-container">
            <div class="row" style="--bs-gutter-x: 4rem;">
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start align-self-start" style="padding-left: 1rem;">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #5880a4; font-size: 50px;">Our Orthodontic Services</h1>
                        <h3 style="font-weight: 400;">Kami menyediakan berbagai pilihan perawatan ortodonti:</h3>

                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Behel Konvensional (karet)</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Behel Self Ligating</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Clear Aligner</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Myobrace</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Behel lepasan</h3>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h4 style="font-weight: 400; font-size: 25px; margin: 0;">Ditangani langsung oleh dokter spesialis ortodonti berpengalaman</h4>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                            <img style="width:48px;" src="<?= image('blink.png') ?>" class="me-3">
                            <h4 style="font-weight: 400; font-size: 25px; margin: 0;">Menggunakan alat modern dan teknologi canggih untuk perencanaan gigi yang lebih akurat dan efisien.</h4>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                            <img style="width:48px;" src="<?= image('blink.png') ?>" class="me-3">
                            <h4 style="font-weight: 400; font-size: 25px; margin: 0;">Telah berhasil menangani 100+ kasus ortodonti.</h4>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                            <img style="width:48px;" src="<?= image('blink.png') ?>" class="me-3">
                            <h4 style="font-weight: 400; font-size: 25px; margin: 0;">Lokasi strategis dengan ruang perawatan yang nyaman dan estetik.</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container about-container">
            <div class="row align-items-center" style="--bs-gutter-x: 4rem;">
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start" style="padding-left: 1rem;">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #6381a8; font-size: 40px;">Conditions Treated by Our Endodontist</h1>

                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Overbite or underbite</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Open bite or crossbite</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Crowding teeth (gigi bertumpuk dan berjejal)</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Celah pada gigi</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block" style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Rahang maju, dll.</h3>
                            </li>
                        </ul><br>
                        <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20orthodontic%20(behel)%20di%20Seuri%20Dental.%20-seuri.id" class="btn dentalseuri2-btn">
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed " type="button"
                            ...
                            Apakah perawatan behel atau orthodonti bisa dicover asuransi?
                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Perawatan behel (kawat gigi) atau orthodonti secara umum tidak termasuk dalam tanggungan asuransi kesehatan standar, karena dianggap sebagai perawatan estetik atau kosmetik. Namun, beberapa asuransi tertentu menanggung biaya behel apabila dilakukan untuk alasan medis seperti, memperbaiki fungsi pengunyahan atau masalah struktur rahang.
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button"
                            ...
                            Berapa lama perawatan behel di Seuri?

                        </button>
                    </h2>
                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Durasi perawatan behel di Seuri Dental Specialist bervariasi bergantung pada kondisi struktur gigi dan rahang pasien. Perawatan ortodonti (pasang behel) berlangsung kurang lebih ± 1-3 tahun.
                            <br>
                            Karena Seuri Dental Specialist menyediakan layanan ortodonti dengan dokter spesialis orthodonti untuk memastikan waktu perawatan dan hasil perawatan sesuai dengan kebutuhan SeuriChingu.
                ...
                <div class="accordion-item border-0 border-bottom">
                    ...
                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Sistem cicilan untuk perawatan orthodonti (behel) di Seuri Dental Specialist dibagi menjadi dua tahapan. Tahap pertama DP di awal perawatan dan pelunasan ketika proses pemasangan behel.
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button"
                            ...
                            Apa saja layanan di Seuri Dental Spesialis?
                        </button>
                    </h2>
                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            ...
                            <br>
                            Tambal gigi dan perawatan saluran akar
                            <br>
                            Perawatan gigi anak
                            <br>
                            Pencabutan & bedah gigi bungsu
                            <br>
                            Estetika gigi (bleaching, veneer, crown)
                            <br>
                            Pembuatan gigi tiruan dan implan gigi
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button"
                            ...
                            Berapa biaya perawatan behel di Seuri Dental Specialist?
                    ...
                    <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Berapa biaya perawatan behel di Seuri Dental Specialist?
                            Biaya pemasangan behel (kawat gigi) di Seuri Dental Specialist sangat bergantung pada beberapa faktor seperti jenis behel (metal, keramik, self-ligating, aligner), kondisi awal gigi & rahang, apakah diperlukan pencabutan atau tindakan tambahan, serta durasi dan kontrol yang dibutuhkan. Sebagai gambaran pemasangan behel di Seuri Dental Specialist dimulai dari harga Rp. 8.500.000.
    ...
    <section style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container text-left">
            <h2 class="fw-bold text-secondary">
                Orthodontic Bogor: Solusi Senyum Rapi dan Sehat
            </h2>
            <p id="artikel" class="mt-4">
                Memiliki gigi yang rapi bukan hanya soal penampilan, tetapi juga berpengaruh pada kesehatan gigi dan mulut. Perawatan orthodontic Bogor hadir
                sebagai solusi terbaik untuk Anda yang ingin memperbaiki susunan gigi sekaligus meningkatkan rasa percaya diri.

                <br><br>
                Orthodontic Bogor dilakukan oleh dokter gigi spesialis ortodonti yang berpengalaman. Dengan berbagai pilihan perawatan, mulai dari behel
                konvensional, behel estetik (clear braces), hingga aligner transparan, pasien dapat memilih sesuai kebutuhan dan kenyamanan. Setiap perawatan
                orthodontic bertujuan untuk memperbaiki posisi gigi, rahang, dan gigitan, sehingga fungsi mengunyah lebih optimal serta memudahkan perawatan gigi
                di masa depan.
                <br><br>

                Klinik orthodontic Bogor juga didukung dengan teknologi modern, proses konsultasi yang menyeluruh, serta suasana nyaman untuk anak maupun
                dewasa. Dokter akan memberikan rencana perawatan yang dipersonalisasi agar hasil lebih maksimal.
                <br><br>

                Dengan melakukan perawatan orthodontic Bogor, Anda akan mendapatkan senyum indah, gigi lebih sehat, serta rasa percaya diri yang lebih tinggi.
                Kini saatnya mewujudkan senyum terbaik Anda bersama layanan orthodontic Bogor yang profesional dan terpercaya
            </p>
