...
<head>
    ...
    <title>Cabut Gigi - Seuri Dental Specialist</title>
...
<body>
        ...
        <div class="container dentalseuri2-container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5 position-relative text-center">
                    ...
                    <img src="<?= image('cabuthero.png') ?>" alt="senyum" class="dentalseuri2-main-image">
                </div>

                <!-- Kolom Kanan -->
                <div class="col-md-6">
                    <h2 class="dentalseuri2-title">
                        Save Your Teeth with Gentle
                        Tooth Extraction
                    </h2>
                    <p class="dentalseuri2-desc">
                        Dokter gigi di Seuri memastikan setiap tindakan cabut gigi dilakukan dengan aman, presisi, dan nyaman, menggunakan teknik lembut serta peralatan modern. </p>
                    <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20cabut%20gigi%20di%20Seuri%20Dental.%20-seuri.id" class="btn dentalseuri2-btn">
            ...
            <div class="row align-items-center about-row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <div class="about-image-wrapper shadow-lg">
                        <img src="<?= image('cabut.webp') ?>" alt="Dokter gigi sedang melayani pasien"
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start align-self-start">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #5880a4; font-size: 50px;">Our Tooth Extraction
                            Services</h1>
                        <h3 style="font-weight: 400;">
                            Seuri Dental Clinic menyediakan berbagai pilihan perawatan cabut gigi:
                        </h3>
                        <br>
                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                ...
                                <h3 style="font-weight: 400;" class="mb-0">Pencabutan gigi sederhana
                                </h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Pencabutan gigi dengan penyulit</h3>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container mt-5 text-center">
        <h1 class="fw-bold" style="color: #5880a4; font-size: 50px;">
            Why Choose Tooth Extraction at Seuri?
        </h1>
    </div>
    ...
    <div class="container mt-5 d-flex justify-content-center">
        <div class="text-start">
            ...
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Pendekatan yang mengutamakan kenyamanan dengan
            ...
            <h4 style="font-weight: 400; font-size: 25px;">
                <img style="width:48px;" src="<?= image('blink.png') ?>"> Menangani ratusan kasus pencabutan gigi
            </h4>
        </div>
    </div>
</section>
        ...
        <div class="container about-container">
            <div class="row align-items-center" style="--bs-gutter-x: 4rem;">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 d-flex justify-content-end" style="margin-bottom: 0 !important;">
                    <img src="<?= image('cabutcond.png') ?>" alt="Dokter gigi sedang melayani pasien"
                ...
                <div class="col-lg-6 about-content d-flex justify-content-start" style="padding-left: 1rem;">
                    <div>
                        <h1 class="fw-bold mb-4" style="color: #6381a8; font-size: 40px;">Conditions Treated
                        ...
                        <ul class="list-unstyled ms-3">
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Penyakit gusi yang parah</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0">Gigi Berlubang Parah</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Sisa Akar Gigi</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Infeksi atau Abses Gigi</h3>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <span class="me-2 rounded-circle d-inline-block"
                                    style="width:8px; height:8px; background-color:#000;"></span>
                                <h3 style="font-weight: 400;" class="mb-0 ">Pencabutan untuk orthodonti</h3>
                            </li>
                        </ul><br>
                        <a href="https://wa.me/6281280089191?text=Halo%20Seuri%20Dental%20Specialist%2C%20aku%20ingin%20tanya%20mengenai%20perawatan%20cabut%20gigi%20di%20Seuri%20Dental.%20-seuri.id" class="btn dentalseuri2-btn">
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq1">
                            Apakah perawatan cabut gigi bisa menggunakan asuransi?
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq2">
                            Berapa lama perawatan cabut gigi di Seuri dental specialist?

                        </button>
                    </h2>
                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Durasi perawatan cabut di Seuri Dental Specialist berlangsung kurang lebih 30-60 menit. Seuri Dental Specialist menyediakan layanan perawatan cabut gigi dengan dokter gigi umum maupun dokter gigi spesialis bedah mulut yang berpengalaman dan profesional untuk memastikan hasil yang maksimal dan minim nyeri.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button"
                            ...
                            Berapa biaya perawatan cabut gigi di Seuri Dental Specialist?
                    ...
                    <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-secondary">
                            Biaya perawatan tambal gigi dengan dokter gigi umum dan dokter spesialis bedah mulut di Seuri Dental Specialist mulai dari harga Rp. 500.000 bergantung pada tingkat kesulitan kasus.
    ...
    <section style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container text-left">
            <h2 class="fw-bold text-secondary">
                Cabut Gigi Terdekat dengan Penanganan Profesional untuk Masalah Gigi Kompleks
            </h2>
            <p id="artikel" class="mt-4">
                Pencabutan gigi merupakan prosedur medis yang dilakukan ketika gigi tidak dapat dipertahankan melalui perawatan konservatif seperti
                tambalan atau perawatan saluran akar. Apabila mengalami nyeri hebat, gigi goyang, atau infeksi yang tidak merespons perawatan,
                mencari layanan cabut gigi terdekat menjadi langkah tepat untuk memperoleh penanganan segera dan aman.
                <br><br>

                Prosedur ini dilakukan oleh dokter gigi dengan teknik steril dan anestesi lokal sehingga pasien tetap nyaman selama perawatan. Kondisi
                yang umumnya memerlukan pencabutan gigi meliputi gigi berlubang parah, gigi bungsu tumbuh miring (impaksi), gigi retak hingga akar,
                atau gigi yang memicu infeksi periodontal.
                <br><br>

                Memilih layanan cabut gigi terdekat memungkinkan pasien memperoleh penanganan lebih cepat, mengurangi risiko komplikasi, serta
                memudahkan kontrol pascaoperasi. Setelah pencabutan, dokter akan memberikan panduan perawatan pascaoperasi, termasuk menjaga
                kebersihan mulut, menghindari makanan keras, serta jadwal kontrol lanjutan.

                <br><br>
                Dengan melakukan pencabutan gigi secara tepat dan profesional, pasien dapat mencegah penyebaran infeksi, memulihkan fungsi
                mengunyah, dan menjaga kesehatan mulut secara optimal.
            </p>
